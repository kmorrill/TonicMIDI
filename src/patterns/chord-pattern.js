...
export class ChordPattern extends AbstractPattern {
  ...
  constructor({ 
    ...
    this.velocityPattern = velocityPattern || Array(length).fill(90).map((v, i) => i === 0 ? 120 : v);
  }
  ...
  getNotes(stepIndex, context) {
    ...
    if (rhythmManager) {
      ...
      const subdivision = rhythmManager.getSubdivision(stepIndex);
      ...
      const adjustedVelocity = Math.min(127, Math.floor(velocity * velocityFactor));
